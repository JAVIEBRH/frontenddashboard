...
const BidonesVendidosCard = ({
  ...
  const porcentajeCambio = calcularPorcentajeCambio(bidonesVendidos, bidonesMesAnterior);
  ...
  return (
    ...
    >
      ...
      <Box sx={{ 
        ...
        <Chip
          label={`${esPositivo ? '+' : ''}${porcentajeCambio.toFixed(1)}%`}
          size="small"
          sx={{
            background: theme.palette.mode === 'dark' ? 'rgba(0, 191, 255, 0.2)' : 'rgba(0, 191, 255, 0.1)',
            color: esPositivo ? '#059669' : '#dc2626',
            fontWeight: 700,
      ...
      <Box sx={{ 
        ...
        <Chip
          label={`${bidonesMesAnterior} mes anterior`}
          size="small"
          sx={{
            mt: 0.5,
            background: theme.palette.mode === 'dark' ? 'rgba(0, 191, 255, 0.2)' : 'rgba(0, 191, 255, 0.1)',
...
export default BidonesVendidosCard;
