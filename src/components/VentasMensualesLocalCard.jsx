...
const VentasMensualesLocalCard = ({ 
  ...
  useEffect(() => {
    ...
    setData({ ventasMensuales, ventasMesAnterior, porcentajeCambio, esPositivo: porcentajeCambio >= 0, tendenciaMensual });
    ...
    >
      ...
      <Box sx={{ width: '100%', height: 40, mt: 2, position: 'relative', zIndex: 1 }}>
        <svg width="100%" height="40" style={{ overflow: 'visible' }}>
          <defs>
            <linearGradient id="gradientMensual" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#9370db" stopOpacity="0.6"/>
              <stop offset="100%" stopColor="#9370db" stopOpacity="0.1"/>
            </linearGradient>
          </defs>
          <path d={`${generarPuntosGrafico()} L200 40 L0 40 Z`} fill="url(#gradientMensual)" opacity="0.4" />
